    ...
    <div>
      ...
      <div id="gallery" class="relative w-full" data-carousel="slide">
        ...
        <div class="container mx-auto">
            ...
            <div class="dark:text-white text-lg font-bold text-center">Kategori 1</div>
            ...
            <div class="dark:text-white text-lg font-bold text-center">Kategori 2</div>
            <div class="flex justify-center flex-wrap">
                <div class="w-full mx-auto p-4 md:w-1/3 lg:w-1/4">
                    <products-card/>
                </div>
            ...
            <div class="dark:text-white text-lg font-bold text-center">Kategori 3</div>
            <div class="flex justify-center flex-wrap">
                <div class="w-full mx-auto p-4 md:w-1/3 lg:w-1/4">
                    <products-card/>
                </div>
