    ...
    <div>
        ...
        <div class="min-w-screen min-h-screen flex items-center justify-center px-5 pb-10 pt-16">
                ...
                <form action="/pay/success" class="w-full mx-auto rounded-lg bg-white dark:bg-gray-800 shadow-lg p-5 text-gray-700" style="max-width: 600px">
                    ...
                    <div class="mb-10">
                        <h1 class="text-center font-bold text-xl uppercase dark:text-white">Secure payment info</h1>
                    </div>
                    ...
                    <div class="mb-3">
                        <label class="font-bold text-sm mb-2 ml-1  dark:text-white">Name on card</label>
                        <div>
                    ...
                    <div class="mb-3">
                        <label class="font-bold text-sm mb-2 ml-1  dark:text-white">Card number</label>
                        <div>
                    ...
                    <div class="mb-3 -mx-2 flex items-end">
                        <div class="px-2 w-1/2">
                            <label class="font-bold text-sm mb-2 ml-1  dark:text-white">Expiration date</label>
                            <div>
                    ...
                    <div class="mb-10">
                        <label class="font-bold text-sm mb-2 ml-1  dark:text-white">Security code</label>
                        <div>
